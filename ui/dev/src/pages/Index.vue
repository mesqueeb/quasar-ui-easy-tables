<template>
  <q-page padding class="column">
    <q-list dense class="list">
      <div class="text-h4 q-my-md">< EasyTable /></div>
      <div class="q-my-md">Generate an entire table via just a "schema" object</div>
      <q-item
        v-for="page in pagesEasyTable"
        :key="page.path"
        :to="page.path"
      >
    ...
    <q-list class="row">
        ...
        <q-item clickable tag="a" target="_blank" href="https://github.com/mesqueeb/quasar-ui-easy-tables">
          <q-item-section avatar>
          ...
          <q-item-section>
            ...
            <q-item-label caption>mesqueeb/quasar-ui-easy-tables</q-item-label>
          </q-item-section>
        </q-item>
